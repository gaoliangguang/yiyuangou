...
<script type="text/javascript">
 ...
 <div class="footers">
            ...
            <div class="footer">
                <div class="yFootSupport">
                    <div class="yFootSupport_in">
                           ...
                           <dl class="dl_Time">
                               <dd title="服务热线" style="background:url(<?php echo G_GLOBAL_STYLE; ?>/images/phone.png) no-repeat 0px 5px;">13427928077</dd>
                               ...
                               <dd title="闪购公益基金"  id="nowTime" class="sysTime" style="background:url(<?php echo G_GLOBAL_STYLE; ?>/images/fund.png) no-repeat 0px 6px;background-size:21px;">
                        ...
                        <div class="footer-time-list">
                            <div class="yFootBottomRight">
                             &nbsp; Copyright © 2015-2016  1元云购 版权所有 &nbsp; 技术支持： &nbsp;<a href="#" target="_blank" >1元云</a> 
                            </div>
	...
	<!--右侧导航-->
<!-- .site-footer END -->
<div style="height: 763px;" class="Left-fixed-divs">
	<ul>
