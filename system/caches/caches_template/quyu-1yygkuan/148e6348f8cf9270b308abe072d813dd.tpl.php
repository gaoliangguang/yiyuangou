    ...
    <div class="wrapper">
      ...
      <span class="fr"><a href="<?php echo WEB_PATH; ?>">返回首页</a></span>
       ...
       <div class="g-links">
           ...
           <a target="_blank" href="<?php echo WEB_PATH; ?>/help/15" title="关于云购">关于云购</a><s></s>
           ...
           <a target="_blank" href="<?php echo WEB_PATH; ?>/help/13" title="加入云购">加入云购</a><s></s>
           <a target="_blank" href="<?php echo WEB_PATH; ?>/help/18" title="联系我们">联系我们</a>
       </div>
       <div class="g-copyright">
           Copyright  &copy;  2011 - 2015,  极光闪购 版权所有  
       </div>
   </div>
