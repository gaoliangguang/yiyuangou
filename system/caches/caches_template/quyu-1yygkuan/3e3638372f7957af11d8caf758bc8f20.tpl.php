	...
	.c_valid_error{ min-width:100px;}
			...
			<div class="c_info_left">
				...
				<div class="c_person_greet">
					<p class="c_greet"><span class="c_time_period">Hi！</span>，<b style="color:#06F;"><?php echo $member['username']; ?></b>一元云购有梦想就要惊喜！</p>
					...
					<li>昵称：<div class="c_already_user">
						...
						<!-- 绑定微信 -->
						<?php if($member['wxband']!=null): ?>
						<li>微信：<span>已绑定</span>&nbsp;<a href="<?php echo WEB_PATH; ?>/member/home/modify" class="c_mail_update">[修改]</a></li>
						<?php  else: ?>
						<li>微信：<span>未绑定</span>&nbsp;<a href="<?php echo WEB_PATH; ?>/member/user/wxband" class="c_mail_update">[马上绑定]</a></li>
						<?php endif; ?>
						...
						<li>
							...
							<a class="c_quick_recharge c_quick_sign" id="memberSign" style="position:relative;top:6px;width: auto;"><input name="submit" type="submit" class="c_quick_recharge c_quick_sign" style="position: relative; top: -4px; width: auto; height: 26px; font-family: 微软雅黑;" value="立即签到"></a>
		...
		<div class="c_person_detail">
			...
			<div class="c_account_center">
				<ul>
					...
					<li>可用夺宝币：<span id="redCount"><?php echo $member['score']; ?></span>&nbsp个</li>
				</ul>
				<ul>
