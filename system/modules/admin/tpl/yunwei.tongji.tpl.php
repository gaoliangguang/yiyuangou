...
<script type="text/javascript" src="<?php echo G_GLOBAL_STYLE; ?>/global/index/js/custom/dashboard.js"></script>
 ...
 <body>
  <div class="layout_top_header">
            <div style="float: left"><span style="font-size: 16px;line-height: 45px;padding-left: 20px;color: #8d8d8d">创资源后台管理系统</span></div>
            <div id="ad_setting" class="ad_setting">
                ...
                <ul class="dropdown-menu-uu" style="display: none" id="ad_setting_ul">
                    <li class="ad_setting_ul_li"> <a href="javascript:;"><i class="icon-user glyph-icon"></i> 添加管理员 </a> </li>
                    <li class="ad_setting_ul_li"> <a href="javascript:;"><i class="icon-cog glyph-icon"></i> 管理员管理 </a> </li>
